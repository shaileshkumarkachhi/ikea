...
var map = {
	...
	"./bs-component/bs-component.module": [
		...
		"default~bs-component-bs-component-module~dashboard-dashboard-module~layout-layout-module~my-orders-m~ec1d2c6f",
		"common",
		"bs-component-bs-component-module"
	],
...
var AppComponent = /** @class */ (function () {
    function AppComponent(rendered) {
...
/*!*********************************!*\
  !*** ./src/app/shared/index.ts ***!
  \*********************************/
/*! exports provided: SharedPipesModule, PageHeaderModule, StatModule, AuthGuard, ApiCallService, ApiCallLoginService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ApiCallService", function() { return _services__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ApiCallLoginService", function() { return _services__WEBPACK_IMPORTED_MODULE_3__["ApiCallLoginService"]; });
...
module.exports = "<div class=\"card bg-white\">\n  <div class=\"card-header\">\n    <div class=\"row\">\n      <div class=\"col col-xs-3\">\n        <span class=\"fa-3x\">{{count}}</span>\n      </div>\n      <div class=\"col col-xs-9 text-right\">\n        <div class=\"d-block huge\"><i class=\"fa {{icon}} fa-2x\"></i></div>\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-md-12\">\n        <div class=\"d-block\">{{label}}</div>\n      </div>\n    </div>\n  </div>\n</div>"
...
module.exports = ".bg-white {\n  background-color: #FFF !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/shared/services/api-call.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/shared/services/api-call.service.ts ***!
  \*****************************************************/
...
var ApiCallService = /** @class */ (function () {
    function ApiCallService(http) {
        this.http = http;
        this.rootUrl = 'http://35.228.226.220';
    }
    ApiCallService.prototype.post = function (url) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        var headerOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({
    ...
    ApiCallService.prototype.put = function (url) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    ApiCallService.prototype.delete = function (url) {
        var headerOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({
            'Content-Type': 'application/json',
            'x-access-token': localStorage.getItem('auth_token')
        });
...
/***/ "./src/app/shared/services/api-login-call.service.ts":
/*!***********************************************************!*\
  !*** ./src/app/shared/services/api-login-call.service.ts ***!
  \***********************************************************/
/*! exports provided: ApiCallLoginService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiCallLoginService", function() { return ApiCallLoginService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm5/http.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var ApiCallLoginService = /** @class */ (function () {
    function ApiCallLoginService(http) {
        this.http = http;
        this.rootUrl = 'http://35.228.182.60';
    }
    ApiCallLoginService.prototype.post = function (url) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    ApiCallLoginService.prototype.get = function (url) {
        var headerOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({
            'Content-Type': 'application/json',
            'x-access-token': localStorage.getItem('auth_token')
        });
    ...
    ApiCallLoginService.prototype.put = function (url) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    ApiCallLoginService.prototype.delete = function (url) {
        var headerOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({
            'Content-Type': 'application/json',
            'x-access-token': localStorage.getItem('auth_token')
        });
    ...
    ApiCallLoginService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_1__["Http"]])
    ], ApiCallLoginService);
    return ApiCallLoginService;
}());
...
/*!******************************************!*\
  !*** ./src/app/shared/services/index.ts ***!
  \******************************************/
/*! exports provided: ApiCallService, ApiCallLoginService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_call_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api-call.service */ "./src/app/shared/services/api-call.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ApiCallService", function() { return _api_call_service__WEBPACK_IMPORTED_MODULE_0__["ApiCallService"]; });

/* harmony import */ var _api_login_call_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api-login-call.service */ "./src/app/shared/services/api-login-call.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ApiCallLoginService", function() { return _api_login_call_service__WEBPACK_IMPORTED_MODULE_1__["ApiCallLoginService"]; });
...
module.exports = __webpack_require__(/*! /home/shailesh/IKEA/Dashboard/src/main.ts */"./src/main.ts");
